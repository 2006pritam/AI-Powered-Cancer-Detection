...
def show_home_content():
    ...
    st.image("https://placehold.co/600x250/FF6347/FFFFFF?text=Oral+Cancer+Image", caption="Illustrative example of Oral Cancer", use_column_width=True)
    st.write(
    ...
    st.image("https://placehold.co/600x250/98FB98/000000?text=Leukoplakia+Image", caption="Illustrative example of Leukoplakia", use_column_width=True)
    st.write(
    ...
    with col1:
        ...
        st.image("https://img.icons8.com/color/96/pytorch.png", caption="PyTorch Icon", width=60)
        st.write(
    ...
    with col2:
        ...
        st.image("https://img.icons8.com/color/96/google-colab.png", caption="Google Colab Icon", width=60)
        st.write(
    ...
    with col3:
        ...
        st.image("https://img.icons8.com/color/96/scikit-learn.png", caption="Scikit-learn Icon", width=60)
        st.write(
